...
#include "../cmp/CLevels.hpp" // only one cmp for all levels -- lvl status
...
struct ManEntity {
    ...
    ~ManEntity(){
        ...
        //    delete getComponentStorage().template getStorage<CIA>().getData()[i].dt;
        //    getComponentStorage().template getStorage<CIA>().getData()[i].dt = nullptr;
        //}
        //for (int i = 0; i < Capacity; ++i){
        //    delete getComponentStorage().template getStorage<CRenderGL>().getData()[i].modelMatrix;
        //    getComponentStorage().template getStorage<CRenderGL>().getData()[i].modelMatrix = nullptr;
        //}
